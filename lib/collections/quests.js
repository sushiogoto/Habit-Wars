...
Meteor.methods({
  randomEnemy: function() {
    ...
    Meteor.call('questInit', difficulty, function (error, result) {});
  },
  ...
  questAttack: function(type) {
    ...
    var monster = Monsters.findOne({_id: quest.monsterId});
    var subMonster;
    var characterTotalStrength = character.strength + util.getTotalStatsOfEquippedItems(character._id).strength;
